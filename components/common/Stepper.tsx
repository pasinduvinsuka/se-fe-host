...
export default function Stepper({
  ...
  // Define the transition properties for animations
          ...
          {items.map((item, index) => (
            ...
            >
              ...
              {index < items.length - 1 && (
                <div
                  className="custom-dotted-line absolute top-1/2 left-0 sm:left-32 w-36 h-1 border-orange-500 transform translate-y-2 xl:left-44 xl:translate-y-1.5 z-0"
                ></div>
              )}
            </div>
          ))}
